...
from backend.src.common import login_required
from backend.src.service.ai_model_service import AIModelService
...
@model_bp.route('/stream')
@login_required
def ip_cam_stream():
    return render_template('ai_model/stream.html')